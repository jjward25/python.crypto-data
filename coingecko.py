...
bitfinex_data = pd.json_normalize(cg.get_coin_by_id(id='bitcoin', localization='false'))['tickers'][0][0]
coinbase_data = pd.json_normalize(cg.get_coin_by_id(id='bitcoin', localization='false'))['tickers'][0][7] ## for bitcoin, coinbase BTC-USD is the 8th object
#print(bitfinex_data)
...
coin_df = pd.json_normalize(cg.get_coin_by_id(id='bitcoin', localization='false'))[coin_fields]
